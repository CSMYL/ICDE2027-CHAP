# CHAP: Efficient Causal-Incorporated Hierarchy-Aware Prediction for Structured Data

We propose an efficient **C**ausal-Incorporated **H**ierarchy-**A**ware **P**rediction (CHAP) framework, bridging the gap between high-capacity neural network models and causal analysis. CHAP consists of causal-attentive representation, causal dependency extraction, and hierarchy-aware prediction modules.
...
├── raw_data/ #Process data according to dataset chapter
│   ├── creditcard.csv
│   ├── cardio.csv
│   ├── adult.csv
│   ├── diamonds.csv
...
Compare two-stage (NOTEARS causal mask + CHAP predictor) vs end-to-end CHAP:

* **NOTEARS as mask vs CHAP**
  * cd baseline/notears
...
* **Compare CHAP vs CHAP w/o Causal**:
